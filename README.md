# nvim-treesitter-queries-ziggy

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-ziggy/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-ziggy/actions/workflows/validate.yml)

Neovim tree-sitter queries for **ziggy**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-ziggy",
...
- [ ] Changes are scoped to `ziggy` — do not include files for other languages
